...
const CATEGORIES: Category[] = [
  {
    ...
    lightBg: '#EEF2FF', lightIcon: '#4F46E5',
    darkBg: '#1E1B4B', darkIcon: '#818CF8',
  },
  {
    type: 'car',
    label: '자동차',
    icon: 'car-outline',
    lightBg: '#FFF7ED', lightIcon: '#EA580C',
    darkBg: '#1C0F02', darkIcon: '#FB923C',
  },
  {
    type: 'officetel',
    label: '오피스텔',
    icon: 'cube-outline',
    lightBg: '#F5F3FF', lightIcon: '#7C3AED',
    darkBg: '#1A1430', darkIcon: '#A78BFA',
  },
  {
    type: 'house',
    label: '주택',
    icon: 'home-outline',
    lightBg: '#ECFDF5', lightIcon: '#059669',
    darkBg: '#022C22', darkIcon: '#34D399',
  },
  {
    type: 'commercial',
    label: '상가',
    icon: 'storefront-outline',
    lightBg: '#FFF1F2', lightIcon: '#E11D48',
    darkBg: '#1F0A10', darkIcon: '#FB7185',
  },
  {
    type: 'land',
    label: '토지',
    icon: 'map-outline',
    lightBg: '#F0FDFA', lightIcon: '#0D9488',
    darkBg: '#021C1A', darkIcon: '#2DD4BF',
  },
  {
    type: 'equipment',
    label: '중기',
    icon: 'construct-outline',
    lightBg: '#FFFBEB', lightIcon: '#D97706',
    darkBg: '#1C1007', darkIcon: '#FBBF24',
  },
  {
    type: 'other',
    label: '기타',
    icon: 'ellipsis-horizontal-circle-outline',
    lightBg: '#F9FAFB', lightIcon: '#6B7280',
    darkBg: '#1A1A28', darkIcon: '#9CA3AF',
  },
]
...
function CategoryItem({ category, isDark }: CategoryItemProps) {
  ...
  return (
    <Pressable style={styles.categoryItem} onPress={handlePress}>
      ...
      <Text style={[styles.categoryLabel, { color: theme.text.primary }]}>{category.label}</Text>
    </Pressable>
  )
}
